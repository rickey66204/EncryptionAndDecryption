...
namespace WINDecrypt
{
    class EncryptOperation
    {
        ...
        public static async Task EncryptFile(string inFile, string outFile, string password, IProgress<double> progress)
        {
            await Task.Run(() =>
              {
        ...
        public static async Task DecryptFile(string inFile, string outFile, string password, IProgress<double> progress)
        {
            await Task.Run(() => {
                // 创建打开文件流
                    ...
                    fout = File.OpenWrite(outFile))
                {
                    ...
                    if (outValue != lSize)
                    {
                        Debug.WriteLine("File size does not match");
                    }
                }
            });
        }
